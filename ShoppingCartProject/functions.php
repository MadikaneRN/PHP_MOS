...
<?php
	...
	?>
	<dt><?php echo $item1->getItemName();?> </dt>
	<dd> $ <?php echo $item1->getPrice(); ?>
	<a href="cart2.php?action=removeItem&itemId= <?php echo
	$item1->getItemId() ?> "> Remove </a> </dd>
	<?php } ?>
	<dt> Cart Total: </dt>
